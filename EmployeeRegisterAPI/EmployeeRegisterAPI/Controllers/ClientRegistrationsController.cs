...
namespace EmployeeRegisterAPI.Controllers
{
    ...
    public class ClientRegistrationsController : ControllerBase
    {
        ...
        public ClientRegistrationsController(EmployeeDbContext context)
        {
            _context = context;
        }
        ...
        {
            var clientRegistration = await _context.Clients.FindAsync(id);
        ...
        {
            _context.Clients.Add(clientRegistration);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<ClientRegistration>> DeleteClientRegistration(int id)
        {
            ...
            _context.Clients.Remove(clientRegistration);
            await _context.SaveChangesAsync();
